<section class="ac-settings-box -updates">
	...
	<div class="buttons">
		...
		<?php if ( $this->button_update_now ) : ?>
			<button class="button" data-acp-update><?= __( 'Update Now', 'lenuaj-admin-columns' ) ?></button>
		<?php endif; ?>

		<?php if ( $this->button_update_now_disabled ) : ?>
			<button class="button" disabled><?= __( 'Update Now', 'lenuaj-admin-columns' ) ?></button>
		<?php endif; ?>
		...
		<?php if ( $this->button_check_for_updates ) : ?>
			<form method="post">
				...
				<button class="button"><?= __( 'Check for Updates', 'lenuaj-admin-columns' ) ?></button>
			</form>
		<?php endif; ?>
