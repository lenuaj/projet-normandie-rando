...
<section class="ac-setbox ac-ls-settings ac-section" data-section="ls-settings">
	<header class="ac-section__header">
		<div class="ac-setbox__header__title"><?= esc_html__('Settings', 'lenuaj-admin-columns') ?>
			<small>(<?= esc_html__('optional', 'lenuaj-admin-columns') ?>)</small>
		</div>
	</header>
	<form data-form-part="preferences">
		...
		<div class="ac-setbox__row">
			<div class="ac-setbox__row__th">
				<label><?= esc_html__('Conditionals', 'lenuaj-admin-columns') ?></label>
				<small><?= esc_html__(
					...
					<fieldset>
						<div class="row roles">
							<label for="layout-roles-<?= esc_attr($this->id) ?>" class="screen-reader-text">
                                <?= esc_html__('Roles', 'lenuaj-admin-columns') ?>
								<span>(<?= esc_html__('optional', 'lenuaj-admin-columns') ?>)</span>
							</label>
		...
		<div class="ac-setbox__row" id="hide-on-screen">
			<div class="ac-setbox__row__th">
				<label><?= esc_html__('Table Elements', 'lenuaj-admin-columns') ?></label>
				<small><?= esc_html__(
        ...
        if ($number_of_preferences > 0) : ?>
			...
			<div class="ac-setbox__row">
				<div class="ac-setbox__row__th">
					<label><?= esc_html__('Preferences', 'lenuaj-admin-columns') ?></label>
					<small><?= esc_html__(
				...
				<div class="ac-setbox__row__fields -has-subsettings -subsetting-total-<?= $number_of_preferences ?>">
                    ...
                    if ($this->can_horizontal_scroll) : ?>
						...
						<div class="ac-setbox__row -sub -horizontal-scrolling">
							<div class="ac-setbox__row__th">
								<label><?= esc_html__('Horizontal Scrolling', 'lenuaj-admin-columns') ?></label>
                    ...
                    if ($this->can_sort) : ?>
						...
						<div class="ac-setbox__row -sub -sorting" data-setting="sorting-preference">
							<div class="ac-setbox__row__th">
								<label><?= esc_html__('Sorting', 'lenuaj-admin-columns') ?></label>
							</div>
							<div class="ac-setbox__row__fields">
								<div class="ac-setbox__row__fields__inner">
                    ...
                    if ($this->can_bookmark) : ?>
						...
						<div class="ac-setbox__row -sub -predefinedfilters" data-setting="filter-segment-preference">
							<div class="ac-setbox__row__th">
								<label><?= esc_html__('Pre-applied Filters', 'lenuaj-admin-columns') ?></label>
								...
								<div class="ac-setbox__row__fields__inner">
                                    ...
                                    if ( ! empty($segments)): ?>
                                        ...
                                        $select = new Select(
                                            ...
                                            ['' => __('Default', 'lenuaj-admin-columns')] + $segments
                                        );
                    ...
                    if ($this->can_primary_column) : ?>
						...
						<div class="ac-setbox__row -sub -primary-column">
							<div class="ac-setbox__row__th">
								<label><?= esc_html__('Primary Column', 'lenuaj-admin-columns') ?></label>
					...
					<div class="ac-setbox__row -sub -wrapping">
						<div class="ac-setbox__row__th">
							<label><?= esc_html__('Wrapping', 'lenuaj-admin-columns') ?></label>
							...
							<div class="ac-setbox__row__fields__inner">
								<div class="radio-labels">
                                    ...
                                    $select = new Select('wrapping', [
                                        'wrap' => sprintf(
                                            '%s (%s)',
                                            __('Wrap', 'lenuaj-admin-columns'),
                                            __('default', 'lenuaj-admin-columns')
                                        ),
                                        'clip' => __('Clip', 'lenuaj-admin-columns'),
                                    ]);
