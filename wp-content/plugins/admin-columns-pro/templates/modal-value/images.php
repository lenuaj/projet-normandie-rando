			...
			<div class="ac-image-meta">
                ...
                if ($item['filename']) : ?>
					<div class="ac-image-meta-item -filename">
                        <?= __('File name', 'lenuaj-admin-columns') ?>: <strong><?= $item['filename'] ?></strong>
					</div>
                <?php
                endif ?>
                <?php
                if ($item['filetype']) : ?>
					<div class="ac-image-meta-item -filetype">
                        <?= __('File type', 'lenuaj-admin-columns') ?>: <strong><?= $item['filetype'] ?></strong>
					</div>
                <?php
                endif ?>
                <?php
                if ($item['filesize']) : ?>
					<div class="ac-image-meta-item -filesize">
                        <?= __('File size', 'lenuaj-admin-columns') ?>: <strong><?= $item['filesize'] ?></strong>
					</div>
                <?php
                endif ?>
                <?php
                if ($item['dimensions']) : ?>
					<div class="ac-image-meta-item -dimensions">
                        <?= __('Dimensions', 'lenuaj-admin-columns') ?>:
