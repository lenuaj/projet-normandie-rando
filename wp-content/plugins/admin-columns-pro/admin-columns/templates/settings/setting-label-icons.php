				...
				<div class="ac-modal -setting -iconpicker">
					<div class="ac-modal__dialog">
						<div class="ac-modal__dialog__header">
                            ...
                            <?php
                            _e('Select Icon', 'lenuaj-admin-columns'); ?>
						...
						<div class="ac-modal__dialog__content">
                            <?php
                            $groups = [
                                __('Admin Menu', 'lenuaj-admin-columns') => [
                                    'menu',
                                    'menu-alt',
                                    'menu-alt2',
                                    'menu-alt3',
                                ...
                                __('Welcome Screen', 'lenuaj-admin-columns') => [
                                    'welcome-write-blog',
                                    'welcome-add-page',
                                    'welcome-view-site',
                                ...
                                __('Post Formats', 'lenuaj-admin-columns') => [
                                    'format-aside',
                                    'format-image',
                                    'format-gallery',
                                    'format-video',
                                ...
                                __('Image Editing', 'lenuaj-admin-columns') => [
                                    'image-crop',
                                    'image-rotate',
                                    'image-rotate-left',
                                    'image-rotate-right',
                                ...
                                __('Databases', 'lenuaj-admin-columns') => [
                                    'database-add',
                                    'database',
                                    'database-export',
                                    'database-import',
                                ...
                                __('Block Editor', 'lenuaj-admin-columns') => [
                                    'align-full-width',
                                    'align-pull-left',
                                    'align-pull-right',
                                    'align-wide',
                                ...
                                __('TinyMCE', 'lenuaj-admin-columns') => [
                                    'editor-bold',
                                    'editor-italic',
                                    'editor-ul',
                                    'editor-ol',
                                ...
                                __('Posts Screen', 'lenuaj-admin-columns') => [
                                    'align-left',
                                    'align-right',
                                    'align-center',
                                    'align-none',
                                ...
                                __('Social', 'lenuaj-admin-columns') => [
                                    'share',
                                    'share-alt',
                                    'share-alt2',
                                    'rss',
                                ...
                                __('WordPress.org', 'lenuaj-admin-columns') => [
                                    'hammer',
                                    'art',
                                    'migrate',
                                    'performance',
                                ...
                                __('Buddicons', 'lenuaj-admin-columns') => [
                                    'buddicons-activity',
                                ...
                                __('Products', 'lenuaj-admin-columns') => [
                                    'wordpress',
                                    'wordpress-alt',
                                    'pressthis',
                                    'update',
                                ...
                                __('Taxonomies', 'lenuaj-admin-columns') => ['tag', 'category',],
                                __('Widgets', 'lenuaj-admin-columns') => ['archive', 'tagcloud', 'text',],
                                __('Notifications', 'lenuaj-admin-columns') => [
                                    'bell',
                                    'yes',
                                    'yes-alt',
                                    'no',
                                ...
                                __('Miscellaneous', 'lenuaj-admin-columns') => [
                                    'location',
                                    'location-alt',
                                    'vault',
                                    'shield',
