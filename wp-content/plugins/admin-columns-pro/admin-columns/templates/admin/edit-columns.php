		...
		<?php if ( $this->show_actions ) : ?>
			...
			<div class="button-container">
				...
				<?php if ( $this->show_clear_all ) : ?>
					<a class="clear-columns" data-clear-columns><?php _e( 'Clear all columns ', 'lenuaj-admin-columns' ) ?></a>
				<?php endif; ?>

				<span class="spinner"></span>
				<a class="button-primary submit update"><?php _e( 'Update' ); ?></a>
				<a class="button-primary submit save"><?php _e( 'Save' ); ?></a>
				<a class="add_column button">+ <?php _e( 'Add Column', 'lenuaj-admin-columns' ); ?></a>
			</div>
