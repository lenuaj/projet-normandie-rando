    ...
    implements Registerable
{
    ...
    {
        $product = __('Admin Columns', 'lenuaj-admin-columns');
		...
		<div class="info">
			...
			<p class="buttons">
				<a class="button button-primary" href="https://wordpress.org/support/view/plugin-reviews/lenuaj-admin-columns?rate=5#postform" target="_blank"><?php
                    _e('Leave a review!', 'lenuaj-admin-columns'); ?></a>
				<a class="button button-secondary hide-review-notice" href='#' data-dismiss=""><?php
                    _e("Permanently hide notice", 'lenuaj-admin-columns'); ?></a>
			</p>
		</div>
		<div class="help hidden">
			...
			<p>
                ...
                printf(
                    __('You can also find help on the %s, and %s.', 'lenuaj-admin-columns'),
                    '<a href="https://wordpress.org/support/plugin/lenuaj-admin-columns#postform" target="_blank">' . __(
                        'Admin Columns forum on WordPress.org',
                        'lenuaj-admin-columns'
                    ) . '</a>',
                    '<a href="https://wordpress.org/plugins/lenuaj-admin-columns/#faq" target="_blank">' . __(
