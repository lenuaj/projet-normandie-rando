...
class Columns implements Enqueueables, Admin\ScreenOptions, Renderable, RenderableHead
{
    ...
    {
        return new Tweet(
            __("I'm using Admin Columns for WordPress!", 'lenuaj-admin-columns'),
    ...
    public function render(): string
    {
        ...
        ob_start();
        ?>
		<h1 class="screen-reader-text"><?= __('Columns', 'lenuaj-admin-columns'); ?></h1>
			...
			<div class="ac-admin__wrap">
				...
				<div class="ac-admin__sidebar">
                    ...
                    if ( ! $this->list_screen->is_read_only()) : ?>
                        ...
                        $label_main = __('Store settings', 'lenuaj-admin-columns');
