...
class Columns extends Script
{
    ...
    public function register(): void
    {
        ...
        $params = [
            ...
            'i18n'                       => [
                'value'  => __('Value', 'lenuaj-admin-columns'),
                'label'  => __('Label', 'lenuaj-admin-columns'),
                'clone'  => __('%s column is already present and can not be duplicated.', 'lenuaj-admin-columns'),
                'error'  => __('Invalid response.', 'lenuaj-admin-columns'),
                'errors' => [
                    'save_settings'  => __(
