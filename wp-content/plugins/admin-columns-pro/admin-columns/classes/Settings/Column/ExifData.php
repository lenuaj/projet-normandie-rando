...
class ExifData extends Settings\Column
	...
	private function get_exif_types() {
		$exif_types = [
			'aperture'          => __( 'Aperture', 'lenuaj-admin-columns' ),
			'credit'            => __( 'Credit', 'lenuaj-admin-columns' ),
			'camera'            => __( 'Camera', 'lenuaj-admin-columns' ),
			'caption'           => __( 'Caption', 'lenuaj-admin-columns' ),
			'created_timestamp' => __( 'Timestamp', 'lenuaj-admin-columns' ),
			'copyright'         => __( 'Copyright', 'lenuaj-admin-columns' ),
			'focal_length'      => __( 'Focal Length', 'lenuaj-admin-columns' ),
			'iso'               => __( 'ISO', 'lenuaj-admin-columns' ),
			'shutter_speed'     => __( 'Shutter Speed', 'lenuaj-admin-columns' ),
			'title'             => __( 'Title', 'lenuaj-admin-columns' ),
			'orientation'       => __( 'Orientation', 'lenuaj-admin-columns' ),
			'keywords'          => __( 'Keywords', 'lenuaj-admin-columns' ),
		];
