    ...
    implements Settings\FormatValue
{
    ...
    protected function get_display_options()
    {
        ...
        $options = [
            ...
            'edit_author' => __('Edit Post Author', 'lenuaj-admin-columns'),
            'view_author' => __('View Public Post Author Page', 'lenuaj-admin-columns'),
        ];
        ...
        if ($this->column instanceof AC\Column\Relation) {
            $relation_options = [
                ...
                'edit_author' => _x('Edit %s Author', 'post', 'lenuaj-admin-columns'),
                'view_author' => _x('View Public %s Author Page', 'post', 'lenuaj-admin-columns'),
            ];
