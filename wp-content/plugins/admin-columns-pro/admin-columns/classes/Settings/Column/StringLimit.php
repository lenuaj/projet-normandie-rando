...
class StringLimit extends Settings\Column {
	...
	public function create_view() {
		...
		$view = new View( [
			'label'   => __( 'Text Limit', 'lenuaj-admin-columns' ),
			'tooltip' => __( 'Limit text to a certain number of characters or words', 'lenuaj-admin-columns' ),
			'setting' => $setting,
		] );
	...
	private function get_limit_options() {
		$options = [
			''                => __( 'No limit', 'lenuaj-admin-columns' ),
			'character_limit' => __( 'Character Limit', 'lenuaj-admin-columns' ),
			'word_limit'      => __( 'Word Limit', 'lenuaj-admin-columns' ),
		];
