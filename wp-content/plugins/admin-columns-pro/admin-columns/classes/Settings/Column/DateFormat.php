        ...
        $select = $this->create_element('select')
                       ->set_options([
                           self::FORMAT_DATE           => sprintf(
                               '%s (%s)',
                               __('Date', 'lenuaj-admin-columns'),
                               'Y-m-d'
                           ),
                           self::FORMAT_DATETIME       => __('Datetime (ISO)', 'lenuaj-admin-columns'),
                           self::FORMAT_UNIX_TIMESTAMP => __('Timestamp', 'lenuaj-admin-columns'),
                       ]);

        return new View([
            'label'   => __('Date Save Format', 'lenuaj-admin-columns'),
            'setting' => $select,
        ]);
    }
