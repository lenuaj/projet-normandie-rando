...
class UserLink extends Settings\Column
	...
	public function create_view() {
		...
		$view = new View( [
			'label'   => __( 'Link To', 'lenuaj-admin-columns' ),
			'setting' => $select,
		] );
	...
	protected function get_display_options() {
		$options = [
			self::PROPERTY_EDIT_USER   => __( 'Edit User Profile', 'lenuaj-admin-columns' ),
			self::PROPERTY_EMAIL       => __( 'User Email', 'lenuaj-admin-columns' ),
			self::PROPERTY_VIEW_POSTS  => __( 'View User Posts', 'lenuaj-admin-columns' ),
			self::PROPERTY_VIEW_AUTHOR => __( 'View Public Author Page', 'lenuaj-admin-columns' ),
		];
