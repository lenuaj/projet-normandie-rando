...
class User extends Settings\Column implements Settings\FormatValue
{
    ...
    {
        $options = [
            self::PROPERTY_DISPLAY_NAME => __('Display Name', 'lenuaj-admin-columns'),
            self::PROPERTY_FIRST_NAME   => __('First Name', 'lenuaj-admin-columns'),
            self::PROPERTY_FULL_NAME    => __('Full Name', 'lenuaj-admin-columns'),
            self::PROPERTY_LAST_NAME    => __('Last Name', 'lenuaj-admin-columns'),
            self::PROPERTY_NICKNAME     => __('Nickname', 'lenuaj-admin-columns'),
            self::PROPERTY_ROLES        => __('Roles', 'lenuaj-admin-columns'),
            self::PROPERTY_LOGIN        => __('User Login', 'lenuaj-admin-columns'),
            self::PROPERTY_EMAIL        => __('User Email', 'lenuaj-admin-columns'),
            self::PROPERTY_ID           => __('User ID', 'lenuaj-admin-columns'),
            self::PROPERTY_NICENAME     => __('User Nicename', 'lenuaj-admin-columns'),
            self::PROPERTY_URL          => __('User Website', 'lenuaj-admin-columns'),
        ];
