...
class WordLimit extends Settings\Column
	...
	public function create_view() {
		...
		$view = new View( [
			'label'   => __( 'Word Limit', 'lenuaj-admin-columns' ),
			'tooltip' => __( 'Maximum number of words', 'lenuaj-admin-columns' ) . '<em>' . __( 'Leave empty for no limit', 'lenuaj-admin-columns' ) . '</em>',
			'setting' => $setting,
		] );
