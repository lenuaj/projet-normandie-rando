...
class CharacterLimit extends Settings\Column
	...
	public function create_view() {
		...
		$view = new View( [
			'label'   => __( 'Character Limit', 'lenuaj-admin-columns' ),
			'tooltip' => __( 'Maximum number of characters', 'lenuaj-admin-columns' ) . '<em>' . __( 'Leave empty for no limit', 'lenuaj-admin-columns' ) . '</em>',
			'setting' => $word_limit,
		] );
