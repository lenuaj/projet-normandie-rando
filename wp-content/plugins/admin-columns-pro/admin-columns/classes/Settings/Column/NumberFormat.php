...
class NumberFormat extends Settings\Column
	...
	private function get_decimals_setting() {
		...
		$decimals_view = new View( [
			'label'   => __( 'Decimals', 'lenuaj-admin-columns' ),
			'setting' => $decimals,
		] );
	...
	private function get_decimal_point_setting() {
		...
		$decimal_point_view = new View( [
			'label'   => __( 'Decimal point', 'lenuaj-admin-columns' ),
	...
	private function get_thousands_point_setting() {
		...
		$view = new View( [
			'label'   => __( 'Thousands separator', 'lenuaj-admin-columns' ),
			'setting' => $setting,
		] );
	...
	private function get_preview_setting() {
		return new View( [
			'label'   => __( 'Preview', 'lenuaj-admin-columns' ),
	...
	public function create_view() {
		...
		$select = $this->create_element( 'select' )
		               ...
		               ->set_options( [
			               ''          => __( 'Default', 'lenuaj-admin-column' ),
			               'formatted' => __( 'Formatted', 'lenuaj-admin-column' ),
		               ] );
		...
		$view = new View( [
			'label'    => __( 'Number Format', 'lenuaj-admin-columns' ),
			'setting'  => $select,
			'sections' => $sections,
		] );
