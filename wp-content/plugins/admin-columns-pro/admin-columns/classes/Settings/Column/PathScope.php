...
class PathScope extends Settings\Column
	...
	public function create_view() {
		$select = $this->create_element( 'select', 'path_scope' )
		               ->set_options( [
			               'full'             => __( 'Full Path', 'lenuaj-admin-columns' ),
			               'relative-domain'  => __( 'Relative to domain', 'lenuaj-admin-columns' ),
			               'relative-uploads' => __( 'Relative to main uploads folder', 'lenuaj-admin-columns' ),
			               'local'            => __( 'Local Path', 'lenuaj-admin-columns' ),
		               ] );

		$view = new View( [
			'label'   => __( 'Path scope', 'lenuaj-admin-columns' ),
			'tooltip' => __( 'Part of the file path to display', 'lenuaj-admin-columns' ),
			'setting' => $select,
		] );
