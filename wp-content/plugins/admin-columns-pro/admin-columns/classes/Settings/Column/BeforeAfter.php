...
class BeforeAfter extends Column
	...
	public function create_view() {
		...
		$before = new View( [
			'label'       => __( 'Before', 'lenuaj-admin-columns' ),
			'description' => __( 'This text will appear before the column value.', 'lenuaj-admin-columns' ),
			'setting'     => $setting,
			'for'         => $for,
		] );
		...
		$after = new View( [
			'label'       => __( 'After', 'lenuaj-admin-columns' ),
			'description' => __( 'This text will appear after the column value.', 'lenuaj-admin-columns' ),
			'setting'     => $setting,
			'for'         => $setting->get_id(),
		] );
