...
class NumberOfItems extends Settings\Column {
	...
	public function create_view() {
		...
		$view = new View( [
			'label'   => __( 'Number of Items', 'lenuaj-admin-columns' ),
			'tooltip' => __( 'Maximum number of items', 'lenuaj-admin-columns' ) . '<em>' . __( 'Leave empty for no limit', 'lenuaj-admin-columns' ) . '</em>',
			'setting' => $item_limit,
		] );
