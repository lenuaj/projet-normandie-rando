...
class AudioPlayer extends Column {
	...
	public function __construct() {
		$this->set_type( 'column-audio_player' )
		     ...
		     ->set_label( __( 'Audio Player', 'lenuaj-admin-columns' ) );
	}
	...
	public function get_value( $id ) {
		...
		return sprintf( '<audio controls preload="none" src="%s">%s</audio>', esc_url( $url ), __( 'No support for audio player', 'lenuaj-admin-columns' ) );
	}
