...
abstract class Strategy
{
    ...
    public function maybe_ajax_export(): void
    {
        ...
        if ($this->get_export_counter() === null) {
            wp_send_json_error(__('Invalid value supplied for export counter.', 'lenuaj-admin-columns'));
        }
    ...
    public function export(array $ids): void
    {
        ...
        if ( ! $columns) {
            wp_send_json_error(__("No exportable columns found.", 'lenuaj-admin-columns'));
        }
