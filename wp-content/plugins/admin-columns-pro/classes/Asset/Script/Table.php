...
class Table extends Script
{
    ...
    public function register(): void
    {
        ...
        $translation = Translation::create([
            'column_sets'          => [
                'more'        => _x('%s more', 'number of items', 'lenuaj-admin-columns'),
                'switch_view' => __('Switch View', 'lenuaj-admin-columns'),
            ],
            'column_screen_option' => [
                'button_reset'              => _x('Reset', 'column-resize-button', 'lenuaj-admin-columns'),
                'label'                     => __('Columns', 'lenuaj-admin-columns'),
                'resize_columns_tool'       => __('Resize Columns', 'lenuaj-admin-columns'),
                'reset_confirmation'        => sprintf(
                    '%s %s',
                    __('Restore the current column widths and order to their defaults.', 'lenuaj-admin-columns'),
                    __('Are you sure?', 'lenuaj-admin-columns')
                ),
                'save_changes'              => __('Save changes', 'lenuaj-admin-columns'),
    ...
    private function create_column_set_vars(ListScreen $list_screen): array
    {
        ...
        if ($default_segment) {
            $column_set['pre_filtered_label'] = sprintf(
                __('Filtered by: %s', 'lenuaj-admin-columns'),
