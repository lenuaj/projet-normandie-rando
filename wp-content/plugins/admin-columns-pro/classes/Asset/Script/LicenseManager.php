...
class LicenseManager extends Script {
	...
	public function register(): void {
		...
		$translation = Translation::create( [
			'license_removal'             => __( 'Are you sure you want deactivate Admin Columns Pro?', 'lenuaj-admin-columns' ),
			'license_removal_explanation' => __( 'You need to fill in your license key again if you want to reactivate.', 'lenuaj-admin-columns' ),
			'plugin_update_success'       => $this->get_plugin_update_success_string(),
			'updating_plugin'             => __( 'Updating plugin', 'lenuaj-admin-columns' ),
			'plugin_up_to_date'           => __( 'This plugin is up to date', 'lenuaj-admin-columns' ),
		] );
