    ...
    implements AC\Settings\Header
{
    ...
    public function create_header_view()
    {
        ...
        $view = new View([
            'title'    => __('Enable Filtering', 'lenuaj-admin-columns'),
    ...
    public function create_view()
    {
        ...
        // Main settings
        $view = new View();
        $view->set('label', __('Filtering', 'lenuaj-admin-columns'))
        ...
        // Sub settings
        $label_view = new View();
        $label_view->set('label', __('Top label', 'lenuaj-admin-columns'))
                   ->set('tooltip', __("Set the name of the label in the filter menu", 'lenuaj-admin-columns'))
    ...
    {
        return __("Any %s", 'lenuaj-admin-columns');
    }
