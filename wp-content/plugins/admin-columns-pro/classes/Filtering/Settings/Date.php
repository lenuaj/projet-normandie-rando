...
class Date extends Settings
{
    ...
    public function create_view()
    {
        ...
        $options = [
            ''            => __('Daily', 'lenuaj-admin-columns'),
            'monthly'     => __('Monthly', 'lenuaj-admin-columns'),
            'yearly'      => __('Yearly', 'lenuaj-admin-columns'),
            'future_past' => __('Future / Past', 'lenuaj-admin-columns'),
            'range'       => __('Range', 'lenuaj-admin-columns'),
        ];
        ...
        $format_view->set('label', __('Filter by', 'lenuaj-admin-columns'))
                    ->set('tooltip', __('This will allow you to set the filter format.', 'lenuaj-admin-columns'))
