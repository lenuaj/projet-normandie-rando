...
final class TableScriptFactory
{
    ...
    public function create(AC\ListScreen $list_screen): AC\Asset\Script
    {
        ...
        $script->localize(
            'acp_filtering_i18n',
            Translation::create([
                'fetching_results'    => __('Fetching options', 'lenuaj-admin-columns'),
                'label_start_date'    => __('Start date', 'lenuaj-admin-columns'),
                'label_end_date'      => __('End date', 'lenuaj-admin-columns'),
                'label_start_number'  => __('Min', 'lenuaj-admin-columns'),
                'label_end_number'    => __('Max', 'lenuaj-admin-columns'),
                'filter'              => __('Filter', 'lenuaj-admin-columns'),
                'no_results'          => __('No options found', 'lenuaj-admin-columns'),
                ...
                if ('future_past' === $date_type) {
                    ...
                    $filter['options'] = ArrayMapper::map(
                        AC\Helper\Select\Options::create_from_array([
                            'future' => __('Future', 'lenuaj-admin-columns'),
                            'past'   => __('Past', 'lenuaj-admin-columns'),
                        ])
                    );
                }
            }
