    ...
    implements AC\Column\AjaxValue, Sorting\Sortable
{
    ...
    public function __construct()
    {
        ...
        $this->set_label(__('Revisions', 'lenuaj-admin-columns'));
    }
    ...
    public function get_value($post_id)
    {
        ...
        return ac_helper()->html->get_ajax_modal_link(
            sprintf(_n('%d revision', '%d revisions', $count, 'lenuaj-admin-columns'), $count),
            [
    ...
    public function get_ajax_value($post_id): string
    {
        ...
        $view = new View([
            'title'     => sprintf(_n('%d revision', '%d revisions', $count, 'lenuaj-admin-columns'), $count),
