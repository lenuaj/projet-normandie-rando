    ...
    public function get_assets(): Assets
    {
        ...
        $script->localize(
            ...
            Asset\Script\Localize\Translation::create([
                'excluded'   => __('excluded', 'lenuaj-admin-columns'),
                'included'   => __('included', 'lenuaj-admin-columns'),
                'out_of'     => _x('out of', 'x out of x', 'lenuaj-admin-columns'),
                'select_all' => __('Select / Deselect All', 'lenuaj-admin-columns'),
            ])
        );
