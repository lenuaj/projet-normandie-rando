    ...
    public function render_notice(ListScreen $list_screen): void
    {
        if ( ! $list_screen->has_id()) {
            $message = sprintf(
                '%s %s',
                sprintf(
                    __('These settings are %s.', 'lenuaj-admin-columns'),
                    sprintf('<strong>%s</strong>', __('inactive', 'lenuaj-admin-columns'))
                ),
                sprintf(
                    __(
                    ...
                    sprintf('<strong>%s</strong>', __('Save', 'lenuaj-admin-columns')),
                    sprintf(
                        '<strong>%s</strong>',
