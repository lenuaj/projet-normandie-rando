...
class LayoutTabs implements Renderable
{
    ...
    {
        $options = [
            General\LayoutStyle::OPTION_TABS     => _x('Tabs', 'table view display', 'lenuaj-admin-columns'),
            General\LayoutStyle::OPTION_DROPDOWN => _x('Dropdown', 'table view display', 'lenuaj-admin-columns'),
        ];
