...
final class Table extends Script
{
    ...
    public function register(): void
    {
        ...
        wp_localize_script('aca-search-table', 'acp_search_i18n', [
            'select'              => _x('Select', 'select placeholder', 'lenuaj-admin-columns'),
            'add_filter'          => __('Add Filter', 'lenuaj-admin-columns'),
            'days_ago'            => __('days ago', 'lenuaj-admin-columns'),
            'days'                => __('days', 'lenuaj-admin-columns'),
            'shared_segment'      => __('Available to all users', 'lenuaj-admin-columns'),
            'more_search_records' => __('Please enter more characters to narrow down the search results'),
            'no_search_results'   => __('No options found', 'lenuaj-admin-columns'),
            'clear_filters'       => __('Clear filters', 'lenuaj-admin-columns'),
            'segments'            => [
                'search_segments' => __('Type to search', 'lenuaj-admin-columns'),
                'save_filters'    => __('Save Filters', 'lenuaj-admin-columns'),
                'public_filters'  => __('Public', 'lenuaj-admin-columns'),
                'name'            => __('Name', 'lenuaj-admin-columns'),
                'cancel'          => __('Cancel', 'lenuaj-admin-columns'),
                'save'            => __('Save', 'lenuaj-admin-columns'),
