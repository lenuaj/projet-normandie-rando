...
class Settings extends AC\Settings\Column
	...
	public function create_header_view() {
		$view = new View( [
			'title'    => __( 'Enable Sorting', 'lenuaj-admin-columns' ),
	...
	private function tooltip_warning() {
		return new AC\Admin\Tooltip( 'sort_warning', [
			'content'    => sprintf( '<p>%s</p>', __( 'This sorting query can be slow on very large datasets.', 'lenuaj-admin-columns' ) ),
			'link_label' => '<span class="dashicons dashicons-warning"></span>',
			'title'      => __( 'Notice', 'lenuaj-admin-columns' ),
	...
	public function create_view() {
		...
		$view = new View();
		$view->set( 'label', __( 'Sorting', 'lenuaj-admin-columns' ) )
