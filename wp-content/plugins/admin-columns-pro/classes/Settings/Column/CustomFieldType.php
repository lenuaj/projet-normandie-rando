...
class CustomFieldType extends AC\Settings\Column\CustomFieldType
{
    ...
    protected function get_field_type_options()
    {
        ...
        $field_types['choice'][self::TYPE_SELECT] = __(
            'Select',
            'lenuaj-admin-columns'
        );
        $field_types['relational'][AC\Settings\Column\CustomFieldType::TYPE_POST] = __(
            'Post',
            'lenuaj-admin-columns'
        );
        $field_types['relational'][AC\Settings\Column\CustomFieldType::TYPE_USER] = __(
            'User',
            'lenuaj-admin-columns'
        );
