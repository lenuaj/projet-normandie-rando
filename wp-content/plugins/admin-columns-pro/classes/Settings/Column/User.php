...
class User extends AC\Settings\Column\User
{
    ...
    protected function get_display_options()
    {
        ...
        $options[self::PROPERTY_GRAVATAR] = __('Gravatar', 'lenuaj-admin-columns');
        ...
        return [
            [
                'title'   => __('User', 'lenuaj-admin-columns'),
                'options' => $options,
            ],
            [
                'title'   => __('Custom Field', 'lenuaj-admin-columns'),
                'options' => [
                    self::PROPERTY_META => __('Custom Field', 'lenuaj-admin-columns'),
                ],
            ],
        ];
    }
