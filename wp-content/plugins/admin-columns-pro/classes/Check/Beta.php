    ...
    implements Registerable
{
    ...
    {
        return implode(' ', [
            sprintf(__('You are using a beta version of %s.', 'lenuaj-admin-columns'), 'Admin Columns Pro'),
            sprintf(
                __('If you have feedback or have found a bug, please %s.', 'lenuaj-admin-columns'),
                sprintf(
                    '<a href="#" data-ac-modal="feedback">%s</a>',
                    __('leave us a message', 'lenuaj-admin-columns')
                )
            ),
        ]);
    }
