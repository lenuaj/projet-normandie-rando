...
class Export extends AC\Admin\Table
{
    ...
    public function get_rows(): ListScreenCollection
    {
        ...
        if ($list_screens->count() < 1) {
            $this->message = __('No column settings available.', 'lenuaj-admin-columns');
        }
    ...
    {
        $labels = [
            Types::DATABASE => __('Database', 'lenuaj-admin-columns'),
            Types::FILE     => __('File', 'lenuaj-admin-columns'),
        ];
    ...
    public function get_headings(): array
    {
        return [
            ...
            'list-table'   => __('List Table', 'lenuaj-admin-columns'),
            'name'         => __('Name', 'lenuaj-admin-columns'),
            'source'       => __('Source', 'lenuaj-admin-columns'),
            'segments'     => __('Saved Filters', 'lenuaj-admin-columns'),
            'id'           => __('ID', 'lenuaj-admin-columns'),
            'actions'      => '',
        ];
    }
