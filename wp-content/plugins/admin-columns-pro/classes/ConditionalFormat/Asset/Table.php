...
final class Table extends Script
{
    ...
    public function register(): void
    {
        ...
        wp_localize_script($this->get_handle(), 'acp_cf_settings_i18n', [
            'between_and'            => _x('and', 'between_operator', 'lenuaj-admin-columns'),
            'save_apply'             => __('Save &amp; Apply', 'lenuaj-admin-columns'),
            'cancel'                 => __('Cancel', 'lenuaj-admin-columns'),
            'add_rule'               => __('Add Rule', 'lenuaj-admin-columns'),
            'add_another_condition'  => __('Add condition', 'lenuaj-admin-columns'),
            'conditional_formatting' => __('Conditional Formatting', 'lenuaj-admin-columns'),
            'formatting'             => __('Conditional Formatting', 'lenuaj-admin-columns'),
            'formatting_style'       => __('Formatting Style', 'lenuaj-admin-columns'),
    ...
    private function get_documentation_link(): string
    {
        return sprintf(
            ...
            __('documentation', 'lenuaj-admin-columns')
        );
    }
