...
class Text extends EditableType {
	...
	public function __construct( AC\Column $column, $default = self::TYPE_TEXTAREA ) {
		$options = new Select\Options( [
			new Select\Option( self::TYPE_TEXTAREA, __( 'Textarea', 'lenuaj-admin-columns' ) ),
			new Select\Option( self::TYPE_TEXT, __( 'Text', 'lenuaj-admin-columns' ) ),
			new Select\Option( self::TYPE_WYSIWYG, __( 'WYSIWYG', 'lenuaj-admin-columns' ) ),
		] );
