...
class Location extends Comparison implements Comparison\Values
{
    ...
    public function get_values(): Options
    {
        return Options::create_from_array([
            'block'        => _x('Block', 'ACF location', 'lenuaj-admin-columns'),
            'user_form'    => _x('Users', 'ACF location', 'lenuaj-admin-columns'),
            'taxonomy'     => __('Taxonomy'),
            'comment'      => __('Comment'),
            'post_type'    => _x('Post Type', 'ACF location', 'lenuaj-admin-columns'),
            'widget'       => _x('Widget', 'ACF location', 'lenuaj-admin-columns'),
            'options_page' => _x('Option Page', 'ACF location', 'lenuaj-admin-columns'),
            'nav_menu'     => _x('Menu', 'ACF location', 'lenuaj-admin-columns'),
        ]);
    }
