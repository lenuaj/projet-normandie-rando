...
class ProductVariation implements Registerable
{
    ...
    public function enable_variation_list_table($args)
    {
        ...
        if ( ! isset($args['labels'])) {
            $args['labels'] = [
                'name'               => __('Product Variations', 'lenuaj-admin-columns'),
                'singular_name'      => __('Product Variation', 'lenuaj-admin-columns'),
                'all_items'          => __('Product Variations', 'lenuaj-admin-columns'),
                'add_new'            => __('Add New', 'lenuaj-admin-columns'),
                'add_new_item'       => __('Add new variation', 'lenuaj-admin-columns'),
                'edit'               => __('Edit', 'lenuaj-admin-columns'),
                'edit_item'          => __('Edit variation', 'lenuaj-admin-columns'),
                'new_item'           => __('New variation', 'lenuaj-admin-columns'),
                'view'               => __('View variation', 'lenuaj-admin-columns'),
                'view_item'          => __('View variation', 'lenuaj-admin-columns'),
                'search_items'       => __('Search variations', 'woocommerce'),
                'not_found'          => __('No variations found', 'lenuaj-admin-columns'),
                'not_found_in_trash' => __('No variations found in trash', 'lenuaj-admin-columns'),
                'insert_into_item'   => __('Insert into variation', 'lenuaj-admin-columns'),
            ];
        }
