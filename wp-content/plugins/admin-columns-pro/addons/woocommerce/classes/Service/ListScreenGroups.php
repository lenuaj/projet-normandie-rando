...
class ListScreenGroups implements Registerable
{
    ...
    {
        $groups->add('woocommerce', __('WooCommerce', 'lenuaj-admin-columns'), 11);
        $groups->add(
            'woocommerce_taxonomy',
            sprintf('%s - %s', __('WooCommerce', 'lenuaj-admin-columns'), __('Taxonomy', 'lenuaj-admin-columns')),
            11
        );
        $groups->add(
            ...
            sprintf(
                '%s - %s',
                __('WooCommerce', 'lenuaj-admin-columns'),
                __('Attribute', 'lenuaj-admin-columns')
            ),
            11
        );
    }
