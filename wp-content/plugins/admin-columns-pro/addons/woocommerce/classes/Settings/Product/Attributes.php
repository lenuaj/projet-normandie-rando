...
class Attributes extends AC\Settings\Column
{
    ...
    public function create_view()
    {
        ...
        $attributes = ['' => __('All attributes', 'lenuaj-admin-columns')] + $attributes;
        ...
        return new View([
            'label'   => __('Show Single', 'lenuaj-admin-columns'),
            'tooltip' => __('Display a single attribute.', 'lenuaj-admin-columns') . ' ' . __(
    ...
    public function get_attributes_custom_labels(): array
    {
        $attributes = [];
