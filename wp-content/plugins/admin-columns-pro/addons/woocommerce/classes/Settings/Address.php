    ...
    implements AC\Settings\FormatValue
{
    ...
    {
        return [
            ''           => __('Full Address', 'lenuaj-admin-columns'),
            'first_name' => __('First Name', 'woocommerce'),
            'last_name'  => __('Last Name', 'woocommerce'),
            'full_name'  => __('Full Name', 'lenuaj-admin-columns'),
            'company'    => __('Company', 'woocommerce'),
            'address_1'  => sprintf(__('Address line %s', 'lenuaj-admin-columns'), 1),
            'address_2'  => sprintf(__('Address line %s', 'lenuaj-admin-columns'), 2),
