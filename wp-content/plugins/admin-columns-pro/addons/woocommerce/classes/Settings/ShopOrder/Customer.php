...
class Customer extends ACP\Settings\Column\User
{
    ...
    protected function get_display_options()
    {
        ...
        $_options = [
            ...
            'billing_company'  => __('Billing Company', 'lenuaj-admin-columns'),
            'billing_country'  => __('Billing Country', 'lenuaj-admin-columns'),
            'billing_email'    => __('Billing Email', 'lenuaj-admin-columns'),
            'customer_since'   => __('Customer Since', 'lenuaj-admin-columns'),
            'order_count'      => __('Order Count', 'lenuaj-admin-columns'),
            'shipping_address' => __('Shipping Address', 'woocommerce'),
            'total_sales'      => __('Total Sales', 'lenuaj-admin-columns'),
        ];

        natcasesort($_options);

        $options[] = [
            'title'   => __('WooCommerce', 'lenuaj-admin-columns'),
            'options' => $_options,
        ];
