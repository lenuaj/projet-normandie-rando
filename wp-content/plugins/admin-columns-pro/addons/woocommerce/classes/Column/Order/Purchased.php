...
use AC;
use ACA\WC\Export\Order\ProductsSold;
use ACA\WC\Search;
use ACA\WC\Sorting;
...
class Purchased extends AC\Column implements AC\Column\AjaxValue, Sortable, Searchable, Exportable
{
    ...
    public function __construct()
    {
        $this->set_type('column-order_purchased')
             ->set_label(__('Products Count', 'lenuaj-admin-columns'))
    ...
    public function get_value($id)
    {
        ...
        $count = sprintf(_n('%d product', '%d products', $count, 'lenuaj-admin-columns'), $count);
