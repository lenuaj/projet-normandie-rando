...
class Venue extends AC\Settings\Column\Post {
	...
	protected function get_display_options() {
		$options = [
			self::PROPERTY_ADDRESS => __( 'Address', 'lenuaj-admin-columns' ),
			self::PROPERTY_CITY    => __( 'City', 'lenuaj-admin-columns' ),
			self::PROPERTY_COUNTRY => __( 'Country', 'lenuaj-admin-columns' ),
			self::PROPERTY_PHONE   => __( 'Phone', 'lenuaj-admin-columns' ),
			self::PROPERTY_TITLE   => __( 'Name', 'lenuaj-admin-columns' ),
			self::PROPERTY_WEBSITE => __( 'Website', 'lenuaj-admin-columns' ),
			self::PROPERTY_ZIP     => __( 'ZIP', 'lenuaj-admin-columns' ),
		];
