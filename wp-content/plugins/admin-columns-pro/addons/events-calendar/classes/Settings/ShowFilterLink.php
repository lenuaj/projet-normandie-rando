...
class ShowFilterLink extends AC\Settings\Column\Toggle
	...
	public function create_view() {
		...
		$view->set_data( [
			'label'   => __( 'Link to Filtered Overview', 'lenuaj-admin-columns' ),
			'tooltip' => __( 'Enabling this option to create a link to the filtered overview of the related post type ', 'lenuaj-admin-columns' ),
		] );
