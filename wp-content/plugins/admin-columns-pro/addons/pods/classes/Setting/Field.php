...
class Field extends AC\Settings\Column
{
    ...
    public function create_view()
    {
        ...
        $no_result = sprintf(__('No %s fields available.', 'lenuaj-admin-columns'), __('Pods', 'pods'));
        $no_result .= ' ' . sprintf(
                __('Create your first %s field.', 'lenuaj-admin-columns'),
        ...
        $view = new View();
        $view->set('label', __('Field', 'lenuaj-admin-columns'))
             ->set('setting', $setting);
    ...
    private function get_field_types()
    {
        ...
        if ($fields) {
            foreach ($fields as $field) {
                ...
                $options[$field['name']] = $field['label'] ?: __('empty label', 'lenuaj-admin-columns');
            }
        }
