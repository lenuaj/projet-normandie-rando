...
class Language extends AC\Column {
	...
	public function __construct() {
		$this->set_type( self::TYPE )
		     ->set_label( __( 'Polylang Language', 'lenuaj-admin-columns' ) )
	...
	protected function register_settings() {
		...
		$message->set_label( __( 'Instructions', 'lenuaj-admin-columns' ) );
		$message->set_message( __( 'This placeholder columns adds the Polylang language flags columns to the list page.', 'lenuaj-admin-column' ) );
