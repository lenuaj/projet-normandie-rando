...
class Profile extends AC\Settings\Column {
	...
	public function create_view() {
		...
		$select
			->set_no_result( sprintf( __( 'No %s fields available.', 'lenuaj-admin-columns' ), __( 'BuddyPress', 'lenuaj-admin-columns' ) ) )
		...
		$view = new View( [
			...
			'description' => sprintf( __( 'Select your %s field.', 'lenuaj-admin-columns' ), __( 'BuddyPress profile', 'lenuaj-admin-columns' ) ),
			'setting'     => $select,
		] );
