    ...
    implements Exportable
{
    ...
    public function __construct()
    {
        ...
        $this->set_label(__('Form (Gutenberg)', 'lenuaj-admin-columns'));
    ...
    private function get_form_title($id)
    {
        ...
        if ( ! $form) {
            return sprintf(__('Form %d', 'lenuaj-admin-columns'), $id);
        }

        $title = sprintf(__('%s (#%s)', 'lenuaj-admin-columns'), $form['title'], $id);
