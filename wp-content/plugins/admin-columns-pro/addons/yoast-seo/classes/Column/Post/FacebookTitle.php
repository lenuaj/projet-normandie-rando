...
class FacebookTitle extends AC\Column\Meta
	...
	public function __construct() {
		$this->set_group( 'yoast-seo' )
		     ->set_label( __( 'Facebook Title', 'lenuaj-admin-columns' ) )
		     ->set_type( 'column-yoast_facebook_title' );
	}

	public function get_meta_key() {
		return '_yoast_wpseo_opengraph-title';
	}
