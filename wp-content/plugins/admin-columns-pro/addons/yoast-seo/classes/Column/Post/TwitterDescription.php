...
class TwitterDescription extends AC\Column\Meta
	...
	public function __construct() {
		$this->set_group( 'yoast-seo' )
		     ->set_label( __( 'Twitter Description', 'lenuaj-admin-columns' ) )
		     ->set_type( 'column-yoast_twitter_description' );
	}

	public function get_meta_key() {
		return '_yoast_wpseo_twitter-description';
	}
